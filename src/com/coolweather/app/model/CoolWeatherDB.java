...
import com.coolweather.app.db.MySqliteOpenHelper;
...
public class CoolWeatherDB {
	...
	public void saveProvience(Province provience){
		if (provience!=null) {
	...
	//从数据库读取全国所有的省份信息
	public List<Province> loadProviences() {
		...
		if (cursor.moveToFirst()) {
			...
			province.setProvienceName(cursor.getString(cursor.getColumnIndex("province_name")));
...
//从数据库读取某城市下所有的县信息
	public List<County> loadCounties(int citiesId) {
		List<County> list=new ArrayList<County>();
		Cursor cursor=db.query("county", null, "city_id=?",new String[]{String.valueOf(citiesId)}, null, null, null);
		if (cursor.moveToFirst()) {
			do {
